...
ColumnLayout {
    ...
    RowLayout {
        ...
        MyNewCoinComponents.Label {
            color: lineEdit.inputHasFocus ? MyNewCoinComponents.Style.defaultFontColor : MyNewCoinComponents.Style.dimmedFontColor
            fontSize: 13
            text: (wordNumber + 1)
        ...
        MyNewCoinComponents.TextPlain {
            ...
            color: wordsMatch ? (MyNewCoinComponents.Style.blackTheme ? "#00FF00" : "#008000") : "#FF0000"
            themeTransition: false
            onTextChanged: {
    ...
    Rectangle {
        id: underLine
        color: lineEdit.inputHasFocus ? MyNewCoinComponents.Style.defaultFontColor : MyNewCoinComponents.Style.appWindowBorderColor
