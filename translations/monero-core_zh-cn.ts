...
<context>
    ...
    <message>
        ...
        <translation>这会使发送或接收MyNewCoin更加简单，并且减少在手动输入地址时发生的错误。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>警告：请勿在别的分叉上重用你的 MyNewCoin 私钥，除非这个分叉内置了重用保护，否则隐私会受到侵害。</translation>
    </message>
    <message>
        ...
        <translation>警告：复制种子单词到剪贴板，可能会暴露给恶意软件，导致你的种子单词被记录，从而MyNewCoin被盗。请手工抄写下这些种子单词。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>内置 MyNewCoin 版本：</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>使用一个第三方的服务器连接到 MyNewCoin 网络。安全性较低，但更加轻便。</translation>
    </message>
    <message>
        ...
        <translation>可以在搜索引擎中查找“MyNewCoin 远程节点”。请注意确保节点由一个可信任的第三方维护。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>为避免 MyNewCoin 环签名所提供的保护被破坏，某个输出不应在别的链上与别的成员结成一个新环而被再次花费掉（这样会导致产生相同的 key image）。尽管这看上去不是什么问题，但当一个重用密钥的 MyNewCoin 拷贝可以让你重新消费已被消费的输出时，这是个大问题。这里，你必须保证这个已存在的输出在两条链上使用了相同的环。&lt;br&gt;MyNewCoin 和其他一些无意伤害你的隐私的重用 MyNewCoin 私钥的软件会自动处理这些。&lt;br&gt;如果你也在使用一个重用私钥的 MyNewCoin 拷贝，而且这个拷贝没有包含这样的保护，你的交易仍然可以在那个拷贝上得到保护，但你需要手动将环输入到此页中，以便你能在后续安全地花费你的 MyNewCoin。&lt;br&gt;如果你没有使用一个不附带此安全特性的重用私钥的 MyNewCoin 拷贝的话，那么你什么都不用做，一切都是自动的。&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>这个环签名已在密钥重用的MyNewCoin链上使用过, 因此重复使用同一个环签名可以避免隐私问题. </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>输入MyNewCoin地址 (例如: 44AFFq5kSiGBoZ...)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>为了能够与MyNewCoin网络通信，您的钱包需要连接到一个MyNewCoin节点。为了最好的隐私，建议运行您自己的节点。</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>除此之外，你还可以指定一个引导节点来快速的使用MyNewCoin。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>如果这是您第一次使用MyNewCoin，请选择此选项。</translation>
    </message>
    <message>
        <location filename="../wizard/WizardHome.qml" line="104"/>
    ...
    <message>
        ...
        <translation>连接您的硬件钱包，以创建一个新MyNewCoin钱包。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>该模式非常适合管理少量的MyNewCoin。您可以访问用于创建和管理交易的基本功能。它会自动连接到MyNewCoin网络，所以您可以立即开始使用MyNewCoin。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>这个地址接收了 %1 个MyNewCoin, 并通过 %2 次的确认. </translation>
    </message>
    <message>
        <location filename="../main.qml" line="1066"/>
        <source>Good signature</source>
